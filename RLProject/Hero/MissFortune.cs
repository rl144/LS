...
namespace RLProject.Champions
{
    public static class MissFortune
    {
        ...
        public static void Load()
        {
            ...
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoR", "Autocast R On Immobile Targets", true).SetValue(true));

            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "Real AA Range", true).SetValue(new Circle(true, Color.DodgerBlue)));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingW", "W Range", true).SetValue(new Circle(true, Color.DodgerBlue)));
        ...
        static void Orbwalking_BeforeAttack(Orbwalking.BeforeAttackEventArgs args)
        {
            ...
            {
                if (Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Combo && RLProject.Menu.Item("comboUseQ", true).GetValue<Boolean>())
                    Q.Cast();

                if (Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Mixed && RLProject.Menu.Item("harassUseQ", true).GetValue<Boolean>())
                    Q.Cast();
            }
        ...
        static void AutoR()
        {
            if (!RLProject.Menu.Item("AutoR", true).GetValue<Boolean>())
                return;
        ...
        static void Jungleclear()
        {
            ...
            if (W.IsReady() && RLProject.Menu.Item("jungleclearUseW", true).GetValue<Boolean>())
