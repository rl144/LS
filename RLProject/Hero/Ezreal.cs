...
namespace RLProject.Champions
{
    public static class Ezreal
    {
        ...
        public static void Load()
        {
            ...
            RLProject.Menu.SubMenu("Harass").AddItem(new MenuItem("harassUseW", "Use W", true).SetValue(false));
            RLProject.Menu.SubMenu("Harass").AddItem(new MenuItem("harassAuto", "Auto Harass (Toggle)", true).SetValue(new KeyBind('T', KeyBindType.Toggle, true)));
            ...
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("killsteal", "Use Killsteal (With R)", true).SetValue(false));
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("jump", "World Fastest Jump to MouseCursor", true).SetValue(new KeyBind('G', KeyBindType.Press)));

            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "Real AA Range", true).SetValue(new Circle(true, Color.FromArgb(250, 244, 192))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingQ", "Q Range", true).SetValue(new Circle(true, Color.FromArgb(250, 244, 192))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingW", "W Range", true).SetValue(new Circle(false, Color.FromArgb(250, 244, 192))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingE", "E Range", true).SetValue(new Circle(false, Color.FromArgb(250, 244, 192))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingR", "R Range", true).SetValue(new Circle(true, Color.FromArgb(250, 244, 192))));
        ...
        static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            if(RLProject.Menu.Item("jump", true).GetValue<KeyBind>().Active)
            {
                if (E.IsReady())
                {
            ...
            if (RLProject.Menu.Item("harassAuto", true).GetValue<KeyBind>().Active && !Player.UnderTurret(true) && Orbwalker.ActiveMode != Orbwalking.OrbwalkingMode.Combo)
                Harass();
        ...
        static void Orbwalking_AfterAttack(AttackableUnit unit, AttackableUnit target)
        {
            ...
            if (Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Combo)
            {
                if (Q.CanCast(Target) && RLProject.Menu.Item("comboUseQ", true).GetValue<Boolean>())
                    Q.Cast(Target);
                else
                if (W.CanCast(Target) && RLProject.Menu.Item("comboUseW", true).GetValue<Boolean>())
                    W.Cast(Target);
            }
            ...
            {
                if (Q.CanCast(Target) && RLProject.Menu.Item("harassUseQ", true).GetValue<Boolean>())
                    Q.Cast(Target);
                else
                if (W.CanCast(Target) && RLProject.Menu.Item("harassUseW", true).GetValue<Boolean>())
                    W.Cast(Target);
            }
        }
        ...
        static void Combo()
        {
            ...
            if (RLProject.Menu.Item("comboUseR", true).GetValue<Boolean>())
            {
        ...
        static void Harass()
        {
            if (!Orbwalking.CanMove(1) || !(Player.ManaPercentage() > RLProject.Menu.Item("harassMana", true).GetValue<Slider>().Value) || Player.IsRecalling())
                return;
        ...
        static void Laneclear()
        {
            ...
            if (Q.IsReady() && RLProject.Menu.Item("laneclearUseQ", true).GetValue<Boolean>())
            {
