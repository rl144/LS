...
namespace RLProject.Champions
{
    public static class Jinx
    {
        ...
        public static void Load()
        {
            ...
            RLProject.Menu.SubMenu("Harass").AddItem(new MenuItem("harassUseW", "Use W", true).SetValue(true));
            ...
            RLProject.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearQnum", "Switch to FISHBONES If Can Hit Minion Number >=", true).SetValue(new Slider(2, 2, 7)));
            ...
            RLProject.Menu.SubMenu("Jungleclear").AddItem(new MenuItem("jungleclearUseW", "Use W", true).SetValue(true));
            RLProject.Menu.SubMenu("Jungleclear").AddItem(new MenuItem("jungleclearMana", "if Mana % >", true).SetValue(new Slider(20, 0, 100)));

            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("antigapcloser", "Use Anti-Gapcloser", true).SetValue(true));
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoE", "Autocast E On Immobile Targets", true).SetValue(true));
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("FISHBONES", "Switch to FISHBONES If Can Hit Enemy Number >=", true).SetValue(new Slider(2, 2, 5)));

            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "Real AA Range", true).SetValue(new Circle(true, Color.HotPink)));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingQ", "Q Range", true).SetValue(new Circle(true, Color.HotPink)));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingW", "W Range", true).SetValue(new Circle(true, Color.HotPink)));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingE", "E Range", true).SetValue(new Circle(false, Color.HotPink)));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingR", "R Range", true).SetValue(new Circle(true, Color.HotPink)));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingPTimer", "Passive Timer", true).SetValue(true));
        ...
        static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (RLProject.Menu.Item("drawingPTimer", true).GetValue<Boolean>())
            {
            ...
            if (RLProject.Menu.Item("drawingTarget").GetValue<Boolean>())
            {
        ...
        {
            if (!RLProject.Menu.Item("antigapcloser", true).GetValue<Boolean>() || Player.IsDead)
                return;
        ...
        static void QSwitchForUnit(AttackableUnit Unit)
        {
            ...
            if (Utility.CountEnemiesInRange(Unit.Position, 200) >= RLProject.Menu.Item("FISHBONES", true).GetValue<Slider>().Value)
            {
                QSwitch(true);
                return;
            }
        ...
        static void AutoE()
        {
            if (!RLProject.Menu.Item("AutoE", true).GetValue<Boolean>())
                return;
        ...
        static void Combo()
        {
            ...
            if (RLProject.Menu.Item("comboUseW", true).GetValue<Boolean>())
            {
            ...
            if (RLProject.Menu.Item("comboUseR", true).GetValue<Boolean>() && R.IsReady() && WLastCastedTime + 1.0 < Game.ClockTime)
            {
        ...
        static void Harass()
        {
            if (!(Player.ManaPercentage() > RLProject.Menu.Item("harassMana", true).GetValue<Slider>().Value))
            {
            ...
            if (RLProject.Menu.Item("harassUseW", true).GetValue<Boolean>() && W.IsReady())
            {
                var Wtarget = TargetSelector.GetTarget(W.Range, TargetSelector.DamageType.Physical, true);
        ...
        static void Laneclear()
        {
            ...
            if (!(Player.ManaPercentage() > RLProject.Menu.Item("laneclearMana", true).GetValue<Slider>().Value))
            {
                if (RLProject.Menu.Item("laneclearUseQ", true).GetValue<Boolean>()) 
                    QSwitch(false);
            ...
            if (RLProject.Menu.Item("laneclearUseQ", true).GetValue<Boolean>())
            {
                ...
                if(target != null)
                    QSwitch((CountEnemyMinionsInRange(target.Position, 200) >= RLProject.Menu.Item("laneclearQnum", true).GetValue<Slider>().Value));
            }
        ...
        static void Jungleclear()
        {
            ...
            if (!(Player.ManaPercentage() > RLProject.Menu.Item("jungleclearMana", true).GetValue<Slider>().Value))
            {
                if (RLProject.Menu.Item("jungleclearUseQ", true).GetValue<Boolean>())
                    QSwitch(false);
            ...
            if (W.CanCast(Mobs[0]) && RLProject.Menu.Item("jungleclearUseW", true).GetValue<Boolean>())
                W.Cast(Mobs[0]);
        }
