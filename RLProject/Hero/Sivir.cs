...
namespace RLProject.Champions
{
    public static class Sivir
    {
        ...
        public static void Load()
        {
            ...
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoQ", "Autocast Q On Immobile Targets", true).SetValue(true));
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoE", "Autocast E Against Targetted Spells", true).SetValue(true));

            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "Real AA Range", true).SetValue(new Circle(true, Color.FromArgb(170,78,25))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingQ", "Q Range", true).SetValue(new Circle(true, Color.FromArgb(170, 78, 25))));
        ...
        {
            if(!RLProject.Menu.Item("AutoE", true).GetValue<Boolean>() || Player.IsDead)
                return;
        ...
        static void Orbwalking_OnAfterAttack(AttackableUnit unit, AttackableUnit target)
        {
            ...
            if (Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Combo && RLProject.Menu.Item("comboUseW", true).GetValue<Boolean>())
            {
                W.Cast();
        ...
        static void AutoQ()
        {
            if (!RLProject.Menu.Item("AutoQ", true).GetValue<Boolean>())
                return;
        ...
        static void Jungleclear()
        {
            ...
            if (RLProject.Menu.Item("jungleclearUseW", true).GetValue<Boolean>())
            {
                if(W.IsReady())
                    W.Cast();
            }
