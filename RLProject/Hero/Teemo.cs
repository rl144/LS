...
namespace RLProject.Champions
{
    public static class Teemo
    {
        ...
        public static void Load()
        {
            ...
            RLProject.Menu.SubMenu("Laneclear").AddItem(new MenuItem("empty1", "Empty", true));
            ...
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "Real AA Range", true).SetValue(new Circle(true, Color.FromArgb(171, 242, 0))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingQ", "Q Range", true).SetValue(new Circle(true, Color.FromArgb(171, 242, 0))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingR", "R Range", true).SetValue(new Circle(false, Color.FromArgb(171, 242, 0))));
