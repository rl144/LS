...
namespace RLProject.Champions
{
    public static class Vayne
    {
        ...
        public static void Load()
        {
            ...
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("autointerrupt", "Use Auto-Interrupt", true).SetValue(true));
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoRQ", "Autocast Q When Using Ultimate", true).SetValue(true));
            RLProject.Menu.SubMenu("Misc").AddItem(new MenuItem("LogicalQ", "Use Logical Q (?)", true).SetValue(true));
            ...
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingP", "Passive Range", true).SetValue(new Circle(true, Color.FromArgb(183, 0, 0))));
            ...
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingCond", "E Crash Prediction", true).SetValue(new Circle(true, Color.Red)));
        ...
        static void Drawing_OnDraw(EventArgs args)
        {
            ...
            var drawingP = RLProject.Menu.Item("drawingP", true).GetValue<Circle>();
            ...
            var drawingCond = RLProject.Menu.Item("drawingCond", true).GetValue<Circle>();
        ...
        {
            if (!RLProject.Menu.Item("autointerrupt", true).GetValue<Boolean>() || Player.IsDead)
                return;
        ...
        {
            if (RLProject.Menu.Item("AutoRQ", true).GetValue<Boolean>())
            {
        ...
        {
            if (!RLProject.Menu.Item("LogicalQ", true).GetValue<Boolean>())
            {
                Q.Cast(Game.CursorPos);
                return;
            }
        ...
        static void Combo()
        {
            ...
            if (RLProject.Menu.Item("comboUseQ", true).GetValue<Boolean>() && !Player.IsWindingUp)
            {
            ...
            if (E.IsReady() && RLProject.Menu.Item("comboUseE", true).GetValue<Boolean>())
            {
        ...
        static void Harass()
        {
            ...
            if (Q.CanCast(target) && RLProject.Menu.Item("harassUseQ", true).GetValue<Boolean>() && !Player.IsWindingUp)
                LogicalQ(true);

            if (E.CanCast(target) && RLProject.Menu.Item("harassUseE", true).GetValue<Boolean>())
            {
        ...
        static void Jungleclear()
        {
            ...
            if (Q.CanCast(Mobs[0]) && RLProject.Menu.Item("jungleclearUseQ", true).GetValue<Boolean>())
                LogicalQ(false);
