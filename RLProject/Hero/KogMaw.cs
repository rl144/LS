    ...
    public static class KogMaw
    {
       ...
       // R 2 = 1500
        ...
        public static void Load()
        {
            ...
            RLProject.Menu.SubMenu("Harass").AddItem(new MenuItem("harassUseR", "Use R", true).SetValue(true));
            RLProject.Menu.SubMenu("Harass").AddItem(new MenuItem("harassMana", "if Mana % >", true).SetValue(new Slider(50, 0, 100)));

            RLProject.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearUseW", "Use W", true).SetValue(false));
            RLProject.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearUseE", "Use E", true).SetValue(true));
            RLProject.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearUseR", "Use R", true).SetValue(true));
            ...
            RLProject.Menu.SubMenu("Jungleclear").AddItem(new MenuItem("jungleclearUseR", "Use R", true).SetValue(true));
            ...
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "Real AA Range", true).SetValue(new Circle(true, Color.FromArgb(0, 216, 255))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingQ", "Q Range", true).SetValue(new Circle(false, Color.FromArgb(0, 216, 255))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingW", "W Range", true).SetValue(new Circle(true, Color.FromArgb(0, 216, 255))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingE", "E Range", true).SetValue(new Circle(false, Color.FromArgb(0, 216, 255))));
            RLProject.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingR", "R Range", true).SetValue(new Circle(true, Color.FromArgb(0, 216, 255))));
        ...
        static void Harass()
        {
            ...
            if (RLProject.Menu.Item("harassUseR", true).GetValue<Boolean>() && R.IsReady())
            {
                var Rtarget = TargetSelector.GetTarget(GetRRange, TargetSelector.DamageType.Magical, true);
                var Rpred = R.GetPrediction(Rtarget);
        ...
        static void Laneclear()
        {
            ...
            if (RLProject.Menu.Item("laneclearUseW", true).GetValue<Boolean>() && W.IsReady())
            {
            ...
            if (RLProject.Menu.Item("laneclearUseR", true).GetValue<Boolean>() && R.IsReady())
            {
        ...
        static void Jungleclear()
        {
            ...
            if (RLProject.Menu.Item("jungleclearUseW", true).GetValue<Boolean>() && W.IsReady())
            {
                W.Cast();
                return;
            }
            ...
            if (RLProject.Menu.Item("jungleclearUseE", true).GetValue<Boolean>() && E.IsReady())
            {
                E.Cast(Mobs[0]);
                return;
            }

            if (RLProject.Menu.Item("jungleclearUseR", true).GetValue<Boolean>() && R.IsReady())
            {
                R.Cast(Mobs[0]);
                return;
            }
