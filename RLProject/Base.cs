...
namespace RLProject
{
    internal static class RLProject
    {
        ...
        internal static void Load()
        {
            try 
	        {
                Console.WriteLine("[RL244] RLProject: " + Type.GetType("RLProject.Champions." + Player.ChampionName).Name + " support");
	        }
	        catch
	        {
                Console.WriteLine("[RL244] RLProject: " + Player.ChampionName + " does not support");
                Game.PrintChat("<font color = \"#00D8FF\">[RL244] RLProject: </font><font color = \"#FF007F\">" + Player.ChampionName + "</font> does not support, Unload.");
		        return;
	        }

            Menu = new Menu("[RL244] RLProject", "RL244_RLProject", true);
            ...
            Type.GetType("RLProject.Champions." + Player.ChampionName).GetMethod("Load").Invoke(null, null);
            ...
            Game.PrintChat("<font color = \"#00D8FF\">[RL244] RLProject:</font> <font color = \"#FF007F\">" + Player.ChampionName + "</font> Loaded");
        }
        ...
        static void Drawing_OnDraw(EventArgs args)
        {
            ...
            var drawMinionLastHit = RLProject.Menu.Item("drawMinionLastHit").GetValue<Circle>();
            var drawMinionNearKill = RLProject.Menu.Item("drawMinionNearKill").GetValue<Circle>();
